...
if __name__ == "__main__":
    ...
    ref_style = synthesiser.compute_style("Models/LibriTTS/testingwoman.wav")

    # Generate speech
    audio = synthesiser.inference(
        text="Hello my name is Khaireddine, I am a BAU student and I am now testing this model.",
        ref_s=ref_style,
    )
