  ...
  return (
    <>
      {!isPlaybarOpen && (
        ...
        >
          <div className="flex h-1 w-96 items-center rounded-full bg-gray-300 dark:bg-black">
            <div
      ...
      <div className={`relative border-t border-gray-200 dark:border-gray-700 bg-background dark:bg-black shadow-md`}>
          ...
          <div className="hidden h-full md:grid md:grid-cols-[25%_50%_25%]">
            ...
            <div className="flex items-center px-4">
              <div className="flex flex-col gap-1">
                <p className="max-w-xs truncate text-sm dark:text-gray-200">
                  {currentAudio?.title}
                </p>
            ...
            <div className="flex flex-col items-center justify-center">
              <div className="flex items-center space-x-3">
                ...
                >
                  <RiReplay10Fill className="h-5 w-5 dark:text-gray-300" />
                </button>
                <button
                  onClick={togglePlayPause}
                  className="flex h-10 w-10 items-center justify-center rounded-full bg-black dark:bg-white text-white dark:text-black"
                >
                  {isPlaying ? (
                ...
                <button
                  ...
                  className="rounded-full p-2 hover:bg-gray-100 dark:hover:bg-gray-800"
                >
                  <RiForward10Fill className="h-5 w-5 dark:text-gray-300" />
                </button>
              </div>
            ...
            <div className="flex items-center justify-end gap-4 px-6">
              ...
              <button
                ...
                className="rounded-full p-1.5 hover:bg-gray-100 dark:hover:bg-gray-800"
              >
                <IoChevronDown className="h-5 w-5 dark:text-gray-300" />
              </button>
            </div>
          </div>
          ...
          <div className="flex h-full md:hidden">
            <div className="flex flex-1 items-center px-4">
              <div className="flex w-full flex-col gap-1">
                <p className="truncate text-sm dark:text-gray-200">{currentAudio?.title}</p>
            ...
            <div className="flex items-center gap-2 px-4">
              ...
              <button
                onClick={togglePlayPause}
                className="flex h-9 w-9 items-center justify-center rounded-full bg-black dark:bg-white text-white dark:text-black"
              >
                {isPlaying ? (
                  <IoPause className="h-5 w-5" />
                ) : (
