...
export function HistoryList({ historyItems: initialHistoryItems }: { historyItems: HistoryItem[] }) {
                          ...
                          <div className="flex items-center gap-3">
                            ...
                            <div className="flex gap-2">
                              ...
                              <button
                                ...
                                className="flex h-8 w-8 items-center justify-center rounded-full bg-gray-100 hover:bg-gray-200 hover:text-red-500"
                              >
                                {isDeleting[item.id] ? (
                                  <span className="h-4 w-4 animate-spin rounded-full border-2 border-gray-300 border-t-gray-500"></span>
                                ) : (
